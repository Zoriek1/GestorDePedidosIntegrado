...
class PedidoRepository(BaseRepository):
    ...
    def buscar_por_status(self, status: str, excluir_ocultos: bool = True) -> List[Pedido]:
    ...
    def buscar_por_data(self, data_inicio: date, data_fim: date, excluir_ocultos: bool = True) -> List[Pedido]:
    ...
    def buscar_por_cliente(self, telefone: str, excluir_ocultos: bool = True) -> List[Pedido]:
    ...
    def buscar_atrasados(self) -> List[Pedido]:
        """Busca pedidos atrasados (excluindo ocultos e concluídos)"""
    ...
    def buscar_por_fonte(self, fonte_id: int, excluir_ocultos: bool = True) -> List[Pedido]:
    ...
    def obter_estatisticas(self) -> Dict:
        ...
        base_query = self.model.query.filter_by(oculto=False)
