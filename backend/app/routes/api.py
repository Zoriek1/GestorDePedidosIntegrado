...
from app import db
from app.models import Pedido, RotaOtimizada, FontePedido
...
def criar_pedido():
    ...
    payload, status_code = PedidosService.criar_pedido(data)
...
def atualizar_pedido(pedido_id):
    ...
    payload, status_code = PedidosService.atualizar_pedido(pedido_id, data or {})
    return jsonify(payload), status_code
