...
def listar_clientes():
    ...
    try:
        ...
        return jsonify({"error": "Erro ao listar clientes", "detalhes": str(e)}), 500
...
def buscar_clientes_autocomplete():
    ...
    try:
        ...
        return jsonify({"success": True, "clientes": [c.to_dict_autocomplete() for c in clientes]})

    except Exception as e:
        return jsonify({"error": "Erro ao buscar clientes", "detalhes": str(e)}), 500
...
def obter_cliente(cliente_id):
    ...
    try:
        ...
        if not cliente:
            return (
                jsonify({"error": "Cliente não encontrado", "cliente_id": cliente_id}),
                404,
            )

        return jsonify({"success": True, "cliente": cliente.to_dict(include_stats=True)})

    except Exception as e:
        return jsonify({"error": "Erro ao obter cliente", "detalhes": str(e)}), 500
...
def deletar_cliente(cliente_id):
    ...
    try:
        ...
        try:
            ensure_backup_before_destructive_action(
                reason="delete_cliente", context={"cliente_id": cliente_id}
            )
        ...
        db.session.rollback()
        return jsonify({"error": "Erro ao deletar cliente", "detalhes": str(e)}), 500
...
def obter_ltv_cliente(cliente_id):
    ...
    try:
        ...
        return jsonify({"error": "Erro ao calcular LTV", "detalhes": str(e)}), 500
...
def obter_pedidos_cliente(cliente_id):
    ...
    try:
        ...
        return jsonify({"error": "Erro ao obter pedidos", "detalhes": str(e)}), 500
...
def listar_enderecos_cliente(cliente_id):
    ...
    try:
        ...
        return jsonify({"error": "Erro ao listar endereços", "detalhes": str(e)}), 500
...
def adicionar_endereco_cliente(cliente_id):
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({"error": "Erro ao adicionar endereço", "detalhes": str(e)}), 500
...
def atualizar_endereco(endereco_id):
    ...
    try:
        ...
        if not endereco:
            return (
                jsonify({"error": "Endereço não encontrado", "endereco_id": endereco_id}),
                404,
            )
        ...
        db.session.rollback()
        return jsonify({"error": "Erro ao atualizar endereço", "detalhes": str(e)}), 500
...
def deletar_endereco(endereco_id):
    ...
    try:
        ...
        try:
            ensure_backup_before_destructive_action(
                reason="delete_endereco", context={"endereco_id": endereco_id}
            )
        except BackupRequiredException as backup_error:
            error_msg = str(backup_error)
            return error_response(
        ...
        db.session.rollback()
        return jsonify({"error": "Erro ao deletar endereço", "detalhes": str(e)}), 500
...
def marcar_endereco_principal(endereco_id):
    ...
    try:
        ...
        db.session.rollback()
        return (
            jsonify({"error": "Erro ao marcar endereço como principal", "detalhes": str(e)}),
            500,
        )
