...
class PedidoSchema(Schema):
    ...
    regra_pagamento = fields.Str(allow_none=True, validate=validate.Length(max=30))
    percentual_entrada = fields.Float(allow_none=True)
    valor_entrada = fields.Decimal(allow_none=True, places=2, as_string=True)
    valor_restante = fields.Decimal(allow_none=True, places=2, as_string=True)
    forma_pagamento_entrada = fields.Str(allow_none=True, validate=validate.Length(max=50))
    forma_pagamento_restante = fields.Str(allow_none=True, validate=validate.Length(max=50))
    entrada_recebida_at = fields.DateTime(allow_none=True)
    saldo_recebido_at = fields.DateTime(allow_none=True)
...
class PedidoUpdateSchema(Schema):
    ...
    regra_pagamento = fields.Str(allow_none=True)
    percentual_entrada = fields.Float(allow_none=True)
    valor_entrada = fields.Decimal(allow_none=True, places=2, as_string=True)
    valor_restante = fields.Decimal(allow_none=True, places=2, as_string=True)
    forma_pagamento_entrada = fields.Str(allow_none=True)
    forma_pagamento_restante = fields.Str(allow_none=True)
    entrada_recebida_at = fields.DateTime(allow_none=True)
    saldo_recebido_at = fields.DateTime(allow_none=True)
