...
class GraphHopperService:
    ...
    def calcular_rota(self, coords_origem: Tuple[float, float], 
    ...
    def calcular_rota_otimizada(self, coords_origem: Tuple[float, float], 
        ...
        if len(waypoints) <= 5:
            return self._calcular_rota_otimizada_exata(coords_origem, waypoints, retornar_origem, vehicle)
        else:
            return self._calcular_rota_otimizada_heuristica(coords_origem, waypoints, retornar_origem, vehicle)
    
    def _calcular_rota_otimizada_exata(self, coords_origem: Tuple[float, float],
                                       waypoints: List[Tuple[float, float]],
                                       retornar_origem: bool,
                                       vehicle: str) -> Optional[Dict]:
    ...
    def _calcular_rota_otimizada_heuristica(self, coords_origem: Tuple[float, float],
                                           waypoints: List[Tuple[float, float]],
                                           retornar_origem: bool,
                                           vehicle: str) -> Optional[Dict]:
    ...
    def otimizar_ordem_waypoints(self, coords_origem: Tuple[float, float],
