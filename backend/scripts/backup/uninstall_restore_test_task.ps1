# Script PowerShell para remover tarefa de teste de restauração do Windows Task Scheduler
...
Write-Host "  REMOVER TAREFA DE TESTE DE RESTAURAÇÃO" -ForegroundColor Cyan
Write-Host "===========================================" -ForegroundColor Cyan
Write-Host ""
