...
from scripts.backup.validate_db import (  # noqa: E402
    ValidationResult,
...
class TestValidateDb(unittest.TestCase):
    ...
    def test_validation_success(self):
        ...
        result = validate_restored_db(
            db_path=self.db_path, app_schema_version="1.0", check_invariants=False
        )
    ...
    def test_schema_version_incompatible_returns_error(self):
        ...
        self.assertTrue(
            any(
                "incompatibilidade" in error.lower() or "schema_version" in error.lower()
    ...
    def test_invariants_check_optional(self):
        ...
        result2 = validate_restored_db(
            db_path=self.db_path, app_schema_version="1.0", check_invariants=True
        )
    ...
    def test_file_not_found_returns_error(self):
        ...
        result = validate_restored_db(
            db_path=non_existent_path, app_schema_version="1.0", check_invariants=False
        )
        ...
        self.assertTrue(
            any(
                "não encontrado" in error.lower() or "not found" in error.lower()
                for error in result.errors
            )
        )
    ...
    def test_validation_result_to_dict(self):
        ...
        result = ValidationResult(success=True, errors=["erro1"], warnings=["warning1"])
