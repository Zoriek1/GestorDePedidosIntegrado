 ...
 */
export function MarketingDiagnosticsModal({ open, onClose }: Props) {
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="lg" fullWidth>
      <DialogTitle>Diagnóstico das integrações de marketing</DialogTitle>
      <DialogContent>
        {configQuery.isLoading || outboxQuery.isLoading ? (
          <Loading />
        ) : configQuery.isError ? (
          <ErrorState message={configQuery.error.message} onRetry={() => configQuery.refetch()} />
        ) : (
