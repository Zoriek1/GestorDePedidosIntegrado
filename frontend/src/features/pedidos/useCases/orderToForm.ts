...
export function orderToForm(pedido: Pedido): PedidoFormData {
  ...
  const formData: PedidoFormData = {
    ...
    regra_pagamento: pedido.regra_pagamento || undefined,
    percentual_entrada: pedido.percentual_entrada ?? undefined,
    valor_entrada: pedido.valor_entrada ?? undefined,
    valor_restante: pedido.valor_restante ?? undefined,
    forma_pagamento_entrada: pedido.forma_pagamento_entrada || '',
    forma_pagamento_restante: pedido.forma_pagamento_restante || '',
